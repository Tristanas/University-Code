...
{
    // MyWorld w;
    GreenfootImage img0 = new GreenfootImage("orange-0.png");
    GreenfootImage img1 = new GreenfootImage("orange-1.png");
    GreenfootImage img2 = new GreenfootImage("orange-2.png");
    GreenfootImage img3 = new GreenfootImage("orange-3.png");
    /**
    ...
    public Orange(Pacman puck, int delayTimer, int i)
    {
        this.puck = puck;
