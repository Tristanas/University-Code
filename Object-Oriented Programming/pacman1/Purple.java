 ...
 */
public class Purple extends Ghost
{
    // MyWorld w;
    GreenfootImage img0 = new GreenfootImage("purple-0.png");
    GreenfootImage img1 = new GreenfootImage("purple-1.png");
    GreenfootImage img2 = new GreenfootImage("purple-2.png");
    GreenfootImage img3 = new GreenfootImage("purple-3.png");
    /**
     * Act - do whatever the Purple wants to do. This method is called whenever
    ...
    public Purple(Pacman puck, int delayTimer, int i)
    {
        this.puck = puck;
