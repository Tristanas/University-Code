...
int main() {
	...
	int *X = new int[numX], *Xi = new int[numX];
	...
	//----- Sprendiniu pasirinkimas ------------------------------------------------
	int counter = 0, points_counter = 0;
	int starting_points[numX * numProcs] = {0};
	...
	//----- Pagrindinis ciklas ------------------------------------------------
	while (true) {
		// Calculating starting points for all processes:
